...
{   
    ...
    {
        type: 'GET',
        url: 'http://84.201.131.165/api/product',
        dataType : "json", 
...
function getProductsByCategory(id){
    $.ajax(
        {
            type: 'GET',
            url: `http://84.201.131.165/api/product/findbycat/${id}`,
            dataType : "json", 
            success: function (data, textStatus)
            { 
                let products = ``;
...
function createProduct(){
    ...
    let url = `http://84.201.131.165/api/product`;
    $.ajax(
    {
        type: 'POST',
        url: url,
...
function editProduct(){
    ...
    let url = `http://84.201.131.165/api/product/${document.forms.createProductForm.title.value}/${document.forms.createProductForm.description.value}/${document.forms.createProductForm.cost.value}/${result}`;
    $.ajax(
    {
        type: 'PUT',
        url: url,
